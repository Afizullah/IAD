...
turtles-own [ energy                 ;; l'energie de l'agent
              ...
              ennemy1                ;; la couleur de l'ennemi 1
              ennemy2                ;; la couleur de l'ennemi 2
...
to setup [ config ]
  ...
  new-Base red green blue 0 -10
  new-Base green red blue -40 10
  new-Base green red blue -40 -10
  new-Base blue green red 40 10
  new-Base blue green red 40 -10
  ...
  ask Bases with [color = blue] [
    set my-bases Bases with [ color = blue ]
    ; appelle la procedure d'activation correspondant a la couleur
    initBlueBase
  ]
...
to go
  ...
  ask Explorers [
    ...
    [ ifelse (color = red)
      ...
      [ carefully[goBlueExplorer][show error-message] ]
    ]
  ]
  ...
  ask RocketLaunchers [
    ...
    [ ifelse (color = red)
      ...
      [ carefully[goBlueRocketLauncher][show error-message] ]
    ]
  ]
  ...
  ask Harvesters [
    ...
    [ ifelse (color = red)
      ...
      [ carefully[goBlueHarvester][show error-message] ]
    ]
  ]
  ...
  ask Bases [
    ...
    [ ifelse (color = red)
      ...
      [ carefully[goBlueBase][show error-message] ]
    ]
  ]
...
to update_energy_watches
  ...
  set energy_blue compute-energy blue
end

;
; Creation d'une nouvelle base de couleur 'c' a la position ('x', 'y')
;
to new-base [ c en1 en2 x y ]
  ; cree la base
  create-Bases 1 [
...
to new-Explorer [ a ]
  ...
  if (([energy] of a > explorer-cost) and create-ok?) [
    ...
    hatch-Explorers 1 [
      ...
      set ennemy1 [ennemy1] of a
      set ennemy2 [ennemy2] of a
...
to drop-wall
  if (not empty? carried-walls-nrj) [
    hatch-Walls 1 [
      ...
      set size 1
      set color gray
      set energy first carried-walls-nrj
      set carrying-food? 0
      set mem0 0
      set mem1 0
      set mem2 0
...
516
BRL
count RocketLaunchers with [color = blue]
17
1
11
...
470
BE
count Explorers with [color = blue]
17
1
11
